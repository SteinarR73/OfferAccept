...
const STEPS: OnboardingStep[] = [
  {
    ...
    description: 'Confirm your email address so recipients trust your offers.',
  ...
  },
  {
    ...
    description: 'Draft an offer letter with your terms and recipient details.',
  ...
  },
  {
    ...
    description: 'Send the offer to your recipient via secure link.',
  ...
  },
  {
    id: 'get-signature',
    label: 'Get it signed',
    description: 'Your recipient signs and a tamper-proof certificate is issued.',
    href: '/dashboard/offers',
    cta: 'View offers →',
  },
];
